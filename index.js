...
//reduce
const unfundedGameCount = GAMES_JSON.reduce((count, game) => {
  return game.pledged < game.goal ? count++ : count + 0;
}, 0);

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of $${totalContributions.toLocaleString(
  "en-US"
)} has been raised for ${totalGames}. Currently, ${unfundedGameCount} ${
  unfundedGameCount === 1 ? "game remains" : "games remain"
...
par1.innerHTML = topGame.name;
firstGameContainer.appendChild(par1);

// do the same for the runner up item
const par2 = document.createElement("p");
par2.innerHTML = secondGame.name;
secondGameContainer.appendChild(par2);
